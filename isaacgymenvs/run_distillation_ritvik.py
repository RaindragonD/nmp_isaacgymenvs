...
import dextrah_lab.tasks.dextrah_eatlas.gym_setup
...
def main(env_cfg, agent_cfg: dict):
    ...
    agent_cfg_folder = "dextrah_lab/tasks/dextrah_eatlas/agents"
    ...
    if args_cli.student is not None:
        ...
        student_ckpt = None
    # teacher_ckpt = None
    # student_ckpt = "/home/ritviks/workspace/git/distillation_results/bd_right_2.pth"
